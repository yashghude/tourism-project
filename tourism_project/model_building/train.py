...
repo_id = "yashghude/tourism-project"
...
# Based on the data description for 'Wellness Tourism Package' prediction
numeric_features = [
    'Age',
...
# Assuming ytrain contains the target variable (0s and 1s)
class_weight = ytrain.value_counts()[0] / ytrain.value_counts()[1]
print(f"Calculated class weight for imbalance: {class_weight}")
